                  ...
                  <el-timeline>
                    ...
                    >
                      <p style="display:flex;justify-content:space-between;padding-right:10px;">
                        ...
                        <!-- <i
                          class="el-icon-check"
                          style="border-radius:50%;background-color:#5CBA40;padding:3px;color:white;"
                        ></i>-->
                        <i
                          class="el-icon-minus"
                          style="border-radius:50%;background-color:#CFCFCF;padding:3px;color:white;"
                        ></i>
                        <!-- <i
                          class="el-icon-close"
                          style="border-radius:50%;background-color:#FB542C;padding:3px;color:white;"
                        ></i>-->
                      </p>
                    </el-timeline-item>
                  </el-timeline>
        ...
        <div class="block">
          <el-timeline>
            <el-timeline-item timestamp="2018/4/12" placement="top">
              <el-card>
                <el-divider content-position="left">11:00~12:00</el-divider>
                <p style="display:flex;align-items:center;">
                  <i class="icon iconfont icon-dot" style="color:#00AF51;font-size:20px;"></i>王小虎 提交于 2018/4/2 20:46
                </p>
                <el-row style="text-align:right;">
                  <el-button type="success" plain size="mini">批准</el-button>
                  <el-button type="danger" plain size="mini">驳回</el-button>
                </el-row>
                <el-divider content-position="left">11:00~12:00</el-divider>
                <p style="display:flex;align-items:center;">
                  <i class="icon iconfont icon-dot" style="color:#FF8A1F;font-size:20px;"></i>王小虎 提交于 2018/4/2 20:46
                </p>
                <el-row style="text-align:right;">
                  <el-button type="success" plain size="mini">批准</el-button>
                  <el-button type="danger" plain size="mini">驳回</el-button>
            ...
            <el-timeline-item timestamp="2018/4/2" placement="top">
              <el-card>
                <el-divider content-position="left">11:00~12:00</el-divider>
                <p style="display:flex;align-items:center;">
                  <i class="icon iconfont icon-dot" style="color:#CFCFCF;font-size:20px;"></i>王小虎 提交于 2018/4/2 20:46
                </p>
                <el-row style="text-align:right;">
                  <el-button type="success" plain size="mini">批准</el-button>
                  <el-button type="danger" plain size="mini">驳回</el-button>
...
export default {
  ...
  methods: {
    initDate(val) {
            ...
            list: [
              {
                ...
                list: [
                  ...
                  {
                    time: '10:00~11:00',
                    task: '淡泊人生的境界：宠辱不惊，闲看庭前。',
                    startStamp: 1598925600,
                    endStamp: 1598929200,
                  },
                  {
                    time: '11:00~12:00',
                    task: '人生就是一场无知的奔忙，为名来。',
      ...
      if (this.dateList[4][6] < dayjs.unix(lastDate).format('YYYY-MM-DD')) {
        this.dateList.push([]);
        for (let j = 0; j < 7; j++) {
